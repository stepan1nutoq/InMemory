...
public class RandomSpawnerUI : MonoBehaviour
{
    ...
    /// Ищем свободную позицию с учетом ВСЕХ существующих объектов
    ...
    /// Получаем ширину спавненного объекта по индексу
    ...
    /// Получаем случайную позицию с учетом ширины объекта
